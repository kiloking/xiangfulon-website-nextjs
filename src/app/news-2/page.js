          ...
          {news.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                key={"news" + id}
                className=" gap-10 mb-20 w-full  md:w-1/3"
              >
                <Link href={`/watcharticle/${id}`} className=" gap-6 w-full ">
                  <div className="mb-7">
                    <img
                      src={"/images/news/" + cover_image}
                      alt=""
                      className="w-full"
                    />
                  </div>
                  <div className="flex items-center gap-6 reak-words pr-6">
                    <div className="text-[#003049] ">
                      <div className="text-lg tracking-wider font-bold">
                        {news_date}
                      </div>
